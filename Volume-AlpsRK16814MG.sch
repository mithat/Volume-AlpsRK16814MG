...
U 1 1 550CA683
P 6950 4500
F 0 "U1" H 6950 5200 60  0000 C CNN
F 1 "SN754410" H 6950 3850 60  0000 C CNN
F 2 "mfk-DIP-16_AriesC84_e" H 6950 4500 60  0001 C CNN
...
U 1 1 550CA83D
P 8150 5350
F 0 "#PWR01" H 8150 5350 40  0001 C CNN
F 1 "DGND" H 8150 5280 40  0000 C CNN
...
U 1 1 550CA86E
P 5950 5350
F 0 "#PWR02" H 5950 5350 40  0001 C CNN
F 1 "DGND" H 5950 5280 40  0000 C CNN
...
U 1 1 550CAD46
P 8400 3650
F 0 "C1" H 8400 3750 40  0000 L CNN
F 1 "100n" H 8406 3565 40  0000 L CNN
F 2 "mfk-C_4.0_2.5_2.5_0.5" H 8438 3500 30  0001 C CNN
...
U 1 1 550CADFB
P 8400 4000
F 0 "#PWR03" H 8400 4000 40  0001 C CNN
F 1 "DGND" H 8400 3930 40  0000 C CNN
...
U 1 1 550CB0E4
P 8150 2400
F 0 "#PWR04" H 8150 2400 40  0001 C CNN
F 1 "DGND" H 8150 2330 40  0000 C CNN
...
U 1 1 550CB3B3
P 7900 2300
F 0 "#FLG05" H 7900 2395 30  0001 C CNN
F 1 "PWR_FLAG" H 7900 2480 30  0000 C CNN
...
U 1 1 550CB3CC
P 7900 1850
F 0 "#FLG06" H 7900 1945 30  0001 C CNN
F 1 "PWR_FLAG" H 7900 2030 30  0000 C CNN
...
U 1 1 550CCC99
P 8550 2100
F 0 "P3" V 8500 2100 50  0000 C CNN
F 1 "VD" V 8600 2100 50  0000 C CNN
F 2 "mfk-TE_282834-2" H 8550 2100 60  0001 C CNN
...
U 1 1 550CCCA8
P 8550 2850
F 0 "P4" V 8500 2850 50  0000 C CNN
F 1 "CTRL" V 8600 2850 50  0000 C CNN
F 2 "mfk-TE_282834-2" H 8550 2850 60  0001 C CNN
...
U 1 1 550CCE69
P 2100 3300
F 0 "P1" V 2050 3300 50  0000 C CNN
F 1 "AB I/O" V 2150 3300 50  0000 C CNN
F 2 "mfk-TE_282834-5" H 2100 3300 60  0001 C CNN
...
U 1 1 550CCF9F
P 2150 4650
F 0 "P2" V 2100 4650 50  0000 C CNN
F 1 "CD I/O" V 2200 4650 50  0000 C CNN
F 2 "mfk-TE_282834-5" H 2150 4650 60  0001 C CNN
...
U 1 1 550CA765
P 3850 4350
F 0 "RV1" H 4900 3750 50  0000 C CNN
F 1 "RK16814MG" H 4900 3650 50  0000 C CNN
F 2 "mfk-ALPS_RK16814MG" V 4150 4750 60  0001 C CNN
F 3 "~" V 4150 4750 60  0000 C CNN
	1    3850 4350
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 550CE6FC
P 5950 3250
F 0 "#PWR07" H 5950 3200 20  0001 C CNN
F 1 "+5VD" H 5950 3350 50  0000 C CNN
...
U 1 1 550CE733
P 8150 1800
F 0 "#PWR08" H 8150 1750 20  0001 C CNN
F 1 "+5VD" H 8150 1900 50  0000 C CNN
...
B8 3A B8 3B 5D 00 00 00 00 49 45 4E 44 AE 42 60 82 7C $EndBitmap
EndData
$EndBitmap
Wire Wire Line
	4700 4450 4600 4450
...
U 1 1 550CF9FF
P 4700 4550
F 0 "#PWR09" H 4700 4550 30  0001 C CNN
...
F 3 "" H 4700 6100 60  0000 C CNN
	...
	1    0    0    -1  
$EndComp
Text Notes 4500 6250 0    40   ~ 0
chassis ground
$Comp
L PWR_FLAG #FLG011
U 1 1 550CFBF4
P 4700 6000
F 0 "#FLG011" H 4700 6095 30  0001 C CNN
F 1 "PWR_FLAG" H 4700 6180 30  0000 C CNN
...
U 1 1 550D1AD1
P 4350 6000
F 0 "P5" H 4430 6000 40  0000 L CNN
F 1 "GND" H 4350 6055 30  0001 C CNN
F 2 "mfk-AVA-20ga" H 4350 6000 60  0001 C CNN
...
U 1 1 550D2A54
P 6250 5550
F 0 "C2" H 6250 5650 40  0000 L CNN
F 1 "1u" H 6256 5465 40  0000 L CNN
F 2 "mfk-C_4.0_2.5_2.5_0.5" H 6288 5400 30  0001 C CNN
F 3 "TDK FK18X5R1A105K" H 6250 5550 60  0001 C CNN
	1    6250 5550
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 550D2ACA
P 6250 5850
F 0 "#PWR012" H 6250 5850 40  0001 C CNN
